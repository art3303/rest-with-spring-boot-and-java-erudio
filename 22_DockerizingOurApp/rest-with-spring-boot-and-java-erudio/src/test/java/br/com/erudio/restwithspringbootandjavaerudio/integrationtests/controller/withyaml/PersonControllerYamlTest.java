...
public class PersonControllerYamlTest extends AbstractIntegrationTest {
    ...
    public void testFindAll() throws JsonMappingException, JsonProcessingException {
        ...
        assertEquals(907, foundPersonSix.getId());
    ...
    public void testFindByName() throws JsonMappingException, JsonProcessingException {
        ...
        assertEquals("Hanni",foundPersonOne.getFirstName());
        assertEquals("Pham",foundPersonOne.getLastName());
        assertEquals("Australia",foundPersonOne.getAddress());
    ...
    public void testHATEOAS() throws JsonMappingException, JsonProcessingException {
        ...
        assertTrue(content.contains("rel: \"self\"\n" +
                "    href: \"http://localhost:8888/api/person/v1/673\""));
        assertTrue(content.contains("rel: \"self\"\n" +
                "    href: \"http://localhost:8888/api/person/v1/410\""));
        assertTrue(content.contains("rel: \"self\"\n" +
                "    href: \"http://localhost:8888/api/person/v1/842\""));

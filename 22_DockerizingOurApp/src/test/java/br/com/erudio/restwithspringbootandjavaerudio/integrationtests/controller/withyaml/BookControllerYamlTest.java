...
public class BookControllerYamlTest extends AbstractIntegrationTest {
    ...
    public void testUpdate() throws JsonMappingException, JsonProcessingException {
        book.setTitle("Newjeans with Hanni");
         ...
         BookVO bookUpdated =  given().spec(specification).config(
                         RestAssuredConfig
                                 .config()
                                 .encoderConfig(EncoderConfig.encoderConfig()
                                         .encodeContentTypeAs(
        ...
        assertEquals("Hanni", bookUpdated.getAuthor());
        assertEquals(78.22,bookUpdated.getPrice());
        assertEquals("Newjeans with Hanni",bookUpdated.getTitle());
    }
    ...
    public void testFindBy() throws JsonMappingException, JsonProcessingException {
        ...
        assertEquals("Hanni", foundBook.getAuthor());
        assertEquals(78.22,foundBook.getPrice());
        assertEquals("Newjeans with Hanni",foundBook.getTitle());
    }
    ...
    public void testFindAll() throws JsonMappingException, JsonProcessingException {
        ...
        BookVO foundBookFive = content.get(3);
    ...
    public void testHATEOAS() throws JsonMappingException, JsonProcessingException {
        ...
        assertTrue(content.contains("rel: \"last\"\n" +
                "  href: \"http://localhost:8888/api/book/v1?direction=asc&page=2&size=5&sort=author,asc\""));
        assertTrue(content.contains(" rel: \"next\"\n" +
                "  href: \"http://localhost:8888/api/book/v1?direction=asc&page=1&size=5&sort=author,asc\""));
        assertTrue(content.contains("rel: \"self\"\n" +
                "  href: \"http://localhost:8888/api/book/v1?page=0&size=5&direction=asc\""));
        assertTrue(content.contains("rel: \"first\"\n" +
                "  href: \"http://localhost:8888/api/book/v1?direction=asc&page=0&size=5&sort=author,asc\""));
